...
public class CharStream
{
    ...
    /** @return  true if a file has be opened, false otherwise. */
    public boolean isOpen() { return reader != null; }

    /** Returns the number of the line currently being scanned.
     * @return 0 (zero) if no file is currently open, or the lineNumber otherwise
     */
     ...
     * method.
     * @param ch the character to return to the stream
     */
    ...
    /** @return the next character from the file, or CharStream.EOF if the
     * end of file has been reached.
     * @throws LexicalError if char is an Illegal character
     */
